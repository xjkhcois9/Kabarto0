...
// بدون orderBy لتجنب الحاجة إلى Composite Index في Firebase
db.collection("orders")
  ...
  .onSnapshot(snapshot => {
    orders = snapshot.docs
      ...
      .sort((a, b) => {
        // ترتيب: ready أولاً ثم delivering ثم delivered — وداخل كل حالة الأحدث أولاً
    ...
    showToast("❌ تعذر الاتصال بقاعدة البيانات — " + err.message);
  });
